...
import { mainCarousel, moreOptionsCarousel } from "@/data/products"
...
function ProductCarousels() {
  return (
    <section className="py-4 bg-[#FBFBFB]" id="produtos">
      <div className="container mx-auto px-4">
        {/* Removido o título e a barra do carrossel */}
        {/* Versão Desktop */}
    ...
    <header className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-4 shadow-lg">
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8">
          <a href="#produtos" onClick={e => e.preventDefault()} className="hover:text-green-400 transition-colors duration-300 font-medium">Produtos</a>
          <a href="#sobre" onClick={e => e.preventDefault()} className="hover:text-green-400 transition-colors duration-300 font-medium">Sobre Empresa</a>
          <a href="#catalogo" onClick={e => e.preventDefault()} className="hover:text-green-400 transition-colors duration-300 font-medium">Catálogo</a>
          <a href="#contato" onClick={e => e.preventDefault()} className="hover:text-green-400 transition-colors duration-300 font-medium">Contato</a>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               <Button 
                 asChild 
                 className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
               >
                <a 
                  href="https://kopu.com.br/?utm_source=lp-copos" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-2"
                  onClick={e => {
                    e.preventDefault();
                    window.open("https://kopu.com.br/?utm_source=lp-copos", "_blank", "noopener,noreferrer");
                  }}
                >
