  ...
  useEffect(() => {
    ...
    return () => {
      if (isOpen) {
        ...
        const savedScrollY = document.body.getAttribute("data-scroll-lock")
              ...
              <div className="space-y-3">
                ...
                <div className="hidden lg:block">
                  {product.budgetUrl ? (
                    <Button
                      asChild
                      className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-6 text-xl rounded-xl transition-all duration-300"
                    >
                      <a
                        href={product.budgetUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2"
                        onClick={e => {
                          e.preventDefault();
                          window.open(product.budgetUrl, "_blank", "noopener,noreferrer");
                        }}
                      >
